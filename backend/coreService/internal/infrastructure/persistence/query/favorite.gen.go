...
func newFavorite(db *gorm.DB, opts ...gen.DOOption) favorite {
	...
	_favorite.TargetType = field.NewInt32(tableName, "target_type")
	_favorite.TargetID = field.NewInt64(tableName, "target_id")
	_favorite.FavoriteType = field.NewInt32(tableName, "favorite_type")
	_favorite.IsDeleted = field.NewBool(tableName, "is_deleted")
	_favorite.CreateTime = field.NewTime(tableName, "create_time")
	_favorite.UpdateTime = field.NewTime(tableName, "update_time")
...
type favorite struct {
	...
	ID           field.Int64
	UserID       field.Int64
	TargetType   field.Int32 // 点赞对象类型 1-媒体 2-评论
	TargetID     field.Int64 // 点赞对象id
	FavoriteType field.Int32 // 点赞类型 1-点赞 2-踩
...
func (f *favorite) updateTableName(table string) *favorite {
	...
	f.TargetType = field.NewInt32(table, "target_type")
	f.TargetID = field.NewInt64(table, "target_id")
	f.FavoriteType = field.NewInt32(table, "favorite_type")
...
func (f *favorite) fillFieldMap() {
	...
	f.fieldMap["target_type"] = f.TargetType
	f.fieldMap["target_id"] = f.TargetID
	f.fieldMap["favorite_type"] = f.FavoriteType
