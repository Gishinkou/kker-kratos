...
const (
	UserService_GetUserInfo_FullMethodName     = "/coreService.api.v1.UserService/GetUserInfo"
	UserService_HelloCore_FullMethodName       = "/coreService.api.v1.UserService/HelloCore"
	UserService_CreateUser_FullMethodName      = "/coreService.api.v1.UserService/CreateUser"
	UserService_UpdateUserInfo_FullMethodName  = "/coreService.api.v1.UserService/UpdateUserInfo"
	UserService_GetUserByIdList_FullMethodName = "/coreService.api.v1.UserService/GetUserByIdList"
)
...
type UserServiceClient interface {
	...
	HelloCore(ctx context.Context, in *HelloCoreRequest, opts ...grpc.CallOption) (*HelloCoreResponse, error)
...
func (c *userServiceClient) HelloCore(ctx context.Context, in *HelloCoreRequest, opts ...grpc.CallOption) (*HelloCoreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloCoreResponse)
	err := c.cc.Invoke(ctx, UserService_HelloCore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	HelloCore(context.Context, *HelloCoreRequest) (*HelloCoreResponse, error)
...
func (UnimplementedUserServiceServer) HelloCore(context.Context, *HelloCoreRequest) (*HelloCoreResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HelloCore not implemented")
}
...
func _UserService_HelloCore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloCoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).HelloCore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_HelloCore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).HelloCore(ctx, req.(*HelloCoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "coreService.api.v1.UserService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HelloCore",
			Handler:    _UserService_HelloCore_Handler,
		},
		{
