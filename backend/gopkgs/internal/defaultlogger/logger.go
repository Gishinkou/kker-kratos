...
import (
	...
	"github.com/Gishinkou/kker-kratos/backend/gopkgs/internal/defaultmiddlewares"
...
func GetLogger() log.Logger {
	...
	logger := log.With(
		...
		"x_trace_id", defaultmiddlewares.GetTraceId(),
		"x_span_id", defaultmiddlewares.GetSpanId(),
	)
