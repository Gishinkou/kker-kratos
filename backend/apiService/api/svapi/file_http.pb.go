...
const OperationFileServicePreSignUploadingPublicFile = "/apiService.svapi.FileService/PreSignUploadingPublicFile"
const OperationFileServiceReportPublicFileUploaded = "/apiService.svapi.FileService/ReportPublicFileUploaded"
...
func _FileService_PreSignUploadingPublicFile0_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		reply := out.(*PreSignUploadPublicFileResponse)
...
func _FileService_ReportPublicFileUploaded0_HTTP_Handler(srv FileServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		reply := out.(*ReportPublicFileUploadedResponse)
		return ctx.Result(200, reply)
	}
}
