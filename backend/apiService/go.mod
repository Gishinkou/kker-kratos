...
require (
	...
	github.com/Gishinkou/kker-kratos/backend/baseService v0.0.0-00010101000000-000000000000
	github.com/Gishinkou/kker-kratos/backend/coreService v0.0.0-00010101000000-000000000000
