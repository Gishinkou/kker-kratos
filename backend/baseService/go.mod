module github.com/Gishinkou/kker-kratos/backend/baseService

go 1.22.8

replace github.com/Gishinkou/kker-kratos/backend/gopkgs => ../gopkgs

replace github.com/Gishinkou/kker-kratos/backend/apiSevice => ../apiSevice
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20241011140022-7cd86eb077dc
